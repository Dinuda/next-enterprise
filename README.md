...
Shad cn is a collection of re-usable components that you can copy and paste in your apps, it is built on top of Tailwind CSS and Radix UI. You can find it here: [https://shadcn.com/](https://ui.shadcn.com/)

```
npm run shadcn-g <component_name>
```
